...
var TimeGrid = function (_Component) {
  ...
  TimeGrid.prototype.renderHeaderCells = function renderHeaderCells(range) {
    ...
    var now = _props5.now;
    var start = _props5.start;
    var end = _props5.end;


    var isNowInRange = _dates2.default.inRange(now, start, end, 'day');
    if (isNowInRange) {
      var nowIndex = _dates2.default.diff(start, now, 'day');
    }
    ...
    return range.map(function (date, i) {
      return _react2.default.createElement(
        ...
        {
          key: i,
          className: (0, _classnames2.default)('rbc-header', { 'rbc-now': isNowInRange && i == nowIndex }),
  ...
  TimeGrid.prototype.positionTimeIndicator = function positionTimeIndicator() {
    ...
    var timeSlotWidth = (this.refs.content.offsetWidth - timeGutter.offsetWidth) / 7;
    var timeSlotWidthPercentage = 100 * timeSlotWidth / this.refs.content.offsetWidth;
    var gutterWidthPercentage = 100 * timeGutter.offsetWidth / this.refs.content.offsetWidth;
