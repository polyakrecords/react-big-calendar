...
var Calendar = _react2.default.createClass({
  ...
  propTypes: {
     ...
     */
    handleMenuClick: _react.PropTypes.func,
  ...
  render: function render() {
    ...
    var _props$handleMenuClic = _props.handleMenuClick;
    var handleMenuClick = _props$handleMenuClic === undefined ? function () {} : _props$handleMenuClic;

    var props = _objectWithoutProperties(_props, ['view', 'toolbar', 'events', 'culture', 'components', 'formats', 'style', 'className', 'elementProps', 'date', 'handleMenuClick']);
